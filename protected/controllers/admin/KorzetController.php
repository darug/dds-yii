...
class KorzetController extends Controller
{
	...
	public $fadmin;
	public $temp;
	public $update="Körzetrész módosítása";
	public $list="Körzet listázása,kezelése";
	public $view="Körzetrész megnézése";
	public $delete="Körzetrész törlése";
	public $manage="Körzet kezelése";
	public $create="Új körzetrész felvétele";
